...
class ResamplingTestCases(TestCase):
    def test_resampling_between_two_files(self):
        ...
        target = open_netcdf("geodataset/tests/data/ice_conc_nh_polstere-100_multi_200611151200.nc")
        source = open_netcdf("geodataset/tests/data/Moorings_2021d179.nc")
        ...
        with open("geodataset/tests/data/pickled.p", 'rb') as pickle_file:
