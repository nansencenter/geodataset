...
class ToolsTestCases(TestCase):
    ...
    def test_method_open_netcdf_for_a_healthy_file(self):
        ...
        test_obj = open_netcdf("geodataset/tests/data/ice_conc_nh_polstere-100_multi_200611151200.nc")
        self.assertTrue(isinstance(test_obj, GeoDataset))
        del test_obj
        test_obj = open_netcdf("geodataset/tests/data/Moorings_2021d179.nc")
